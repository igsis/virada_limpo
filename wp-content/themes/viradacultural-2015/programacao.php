...
<div ng-controller='programacao'>
    ...
    <nav id="programacao-navbar" class="navbar-collapse virada-navbar navbar collapse in" ng-class="{'navbar-fixed-top': !isMobile || !smallDevice}">
        <div class="container-fluid container-menu-minified">
            <div class="row">
				...
				<div id="by-group" class="programacao-navbar-item">
                    <span class="hidden-md">Região:</span>
                    <div class="btn-group">
                        <button type="button" id="btnRegion" class="btn btn-primary dropdown-toggle ng-binding" data-toggle="dropdown" analytics-on="click" analytics-event="Ver por clicado" analytics-category="Commands">
                             zona
                          <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="#" ng-click="data.searchRegion = ''">Todas</a></li>
							<li><a href="#" ng-click="data.searchRegion = 'Centro'">Centro</a></li>
                            <li><a href="#" ng-click="data.searchRegion = 'Sul'">Sul</a></li>
                            <li><a href="#" ng-click="data.searchRegion = 'Norte'">Norte</a></li>
							<li><a href="#" ng-click="data.searchRegion = 'Leste'">Leste</a></li>
							<li><a href="#" ng-click="data.searchRegion = 'Oeste'">Oeste</a></li>
                        </ul>
                    </div>
                </div>
                <div id="by-group" class="programacao-navbar-item">
...
<script type="text/html" id="template-space-grid">
    <div id="programacao-grid" class="panel panel-default hl-carrousel">
        ...
        <div class="panel-heading clearfix">
            ...
            <a class="alignright collapsed" data-toggle="collapse" data-target="#grid-space-<%=id%>">
                <span class="icon arrow_carrot-down_alt2"></span>
            </a>
        </div>
        <div id="grid-space-<%=id%>" class="panel-collapse collapse">
